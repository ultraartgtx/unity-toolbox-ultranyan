...
public class PlayerPrefsX
    {
        ...
        public static void SetDateTime(string name, DateTime dateTime)
        {
            PlayerPrefs.SetString(name, dateTime.ToBinary().ToString());
        }

        public static DateTime GetDateTime(string name)
        {
            var temp = Convert.ToInt64(PlayerPrefs.GetString(name));
